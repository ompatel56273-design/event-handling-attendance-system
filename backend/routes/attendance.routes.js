...
const { generateAttendanceQR, scanAttendanceQR, processAttendance, getEventTurnout } = require('../controllers/attendance.controller');

router.use(auth);

router.get('/events/:eventId/turnout', authorize('EVENT_MEMBER', 'SUPER_ADMIN'), getEventTurnout);
